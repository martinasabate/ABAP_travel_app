...
/* The projection view view that simplifies or alters the representation of an 
underlying view or table */
@EndUserText.label: 'Travel projection view - Processor'
@AccessControl.authorizationCheck: #NOT_REQUIRED

/*(Define how view should be represented in UI, includes info on labelling + display of each field)*/
@UI: {
...
define root view entity ZC_TRAVEL_M_368
  as projection on ZI_TRAVEL_M_368
{
      @UI.facet: [ { id:              'Travel',
                     purpose:         #STANDARD,
