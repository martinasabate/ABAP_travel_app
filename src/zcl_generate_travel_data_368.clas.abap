CLASS zcl_generate_travel_data_368 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_368 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_368.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_368.

*   insert the new table entries
    INSERT ztravel_368 FROM TABLE @itab.
